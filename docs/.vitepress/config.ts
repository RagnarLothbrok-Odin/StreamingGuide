...
export default defineConfig({
    ...
    head: [
        ...
        [
            'meta',
            { property: 'twitter:image:alt', content: 'Streaming Guide | Nuvio, Omni & Stremio' },
        ],
    ...
    themeConfig: {
        ...
        sidebar: [
            ...
            },
            {
                ...
                collapsed: false,
                items: [{ text: 'Overview', link: '/troubleshooting/overview' }],
            },
            {
        ...
        socialLinks: [{ icon: 'discord', link: 'https://discord.gg/Q3ZhdRJ' }],
    },
});
